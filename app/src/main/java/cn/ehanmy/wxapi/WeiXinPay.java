...
public class WeiXinPay {
    ...
    public void init(String appId) {
        mIWXAPI = WXAPIFactory.createWXAPI(ArmsUtils.getContext(), null);
    ...
    public void startWXPay(String appId, String partnerId, String prepayId,
                           String nonceStr, String timeStamp, String sign, PayManager.PayListener listener) {
    ...
    private boolean appIsAvilible(String packageName) {
        final PackageManager packageManager = ArmsUtils.getContext().getPackageManager();// 获取packagemanager
