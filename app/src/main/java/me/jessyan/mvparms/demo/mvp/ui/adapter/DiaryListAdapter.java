...
import me.jessyan.mvparms.demo.mvp.ui.holder.DiaryListItemHolder;
 ...
 * ================================================
 */
public class DiaryListAdapter extends DefaultAdapter<Diary> {

    private OnChildItemClickLinstener onChildItemClickLinstener;

    public DiaryListAdapter(List<Diary> diaries) {
        super(diaries);
    }

    @Override
    public BaseHolder<Diary> getHolder(View v, int viewType) {
        return new DiaryListItemHolder(v, new OnChildItemClickLinstener() {
            @Override
    ...
    public enum ViewName {
        FLLOW, LEFT_IMAGE, RIGHT_IMAGE, VOTE, ITEM, COMMENT, SHARE,
    }
