...
public class MyFollowMemberItemHolder extends BaseHolder<Member> {
    ...
    public MyFollowMemberItemHolder(View itemView, MyFollowMemberAdapter.OnChildItemClickLinstener onChildItemClickLinstener) {
        super(itemView);
    ...
    public void onClick(View view) {
        if (null != onChildItemClickLinstener) {
            switch (view.getId()) {
                case R.id.fllow:
                    onChildItemClickLinstener.onChildItemClick(view, MyFollowMemberAdapter.ViewName.FLLOW, getAdapterPosition());
                    return;
            }
        }
        onChildItemClickLinstener.onChildItemClick(view, MyFollowMemberAdapter.ViewName.ITEM, getAdapterPosition());
