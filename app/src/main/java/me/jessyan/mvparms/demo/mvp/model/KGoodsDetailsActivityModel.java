...
@ActivityScope
public class KGoodsDetailsActivityModel extends BaseModel implements KGoodsDetailsActivityContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public KGoodsDetailsActivityModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<KGoodsDetailsResponse> getGoodsDetails(GoodsDetailsRequest request) {
        return mRepositoryManager.obtainRetrofitService(MainService.class)
                .getKGoodsDetails(request);
    }
