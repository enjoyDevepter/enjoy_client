...
import me.jessyan.mvparms.demo.mvp.ui.holder.MyFollowStoreItemHolder;
 ...
 * ================================================
 */
public class MyFollowStoreAdapter extends DefaultAdapter<Store> {

    private OnChildItemClickLinstener onChildItemClickLinstener;

    public MyFollowStoreAdapter(List<Store> members) {
        super(members);
    }

    @Override
    public BaseHolder<Store> getHolder(View v, int viewType) {
        return new MyFollowStoreItemHolder(v, new OnChildItemClickLinstener() {
            @Override
