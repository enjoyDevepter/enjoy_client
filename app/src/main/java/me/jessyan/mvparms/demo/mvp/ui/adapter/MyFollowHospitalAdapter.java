...
import me.jessyan.mvparms.demo.mvp.ui.holder.MyFollowHospitalItemHolder;
 ...
 * ================================================
 */
public class MyFollowHospitalAdapter extends DefaultAdapter<Hospital> {

    private OnChildItemClickLinstener onChildItemClickLinstener;

    public MyFollowHospitalAdapter(List<Hospital> members) {
        super(members);
    }

    @Override
    public BaseHolder<Hospital> getHolder(View v, int viewType) {
        return new MyFollowHospitalItemHolder(v, new OnChildItemClickLinstener() {
            @Override
    ...
    public int getLayoutId(int viewType) {
        return R.layout.my_follow_hospital_item;
    }
