...
import me.jessyan.mvparms.demo.mvp.ui.holder.MyFollowMemberItemHolder;
 ...
 * ================================================
 */
public class MyFollowMemberAdapter extends DefaultAdapter<Member> {

    private OnChildItemClickLinstener onChildItemClickLinstener;

    public MyFollowMemberAdapter(List<Member> members) {
        super(members);
    }

    @Override
    public BaseHolder<Member> getHolder(View v, int viewType) {
        return new MyFollowMemberItemHolder(v, new OnChildItemClickLinstener() {
            @Override
