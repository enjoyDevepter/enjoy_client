...
/**
 * Created by guomin on 2018/9/12.
 */
public class GrowthValueProgress extends View {

    private int currentValues;//当前成长值
    ...
    private int lineHeight = ArmsUtils.getDimens(getContext(), R.dimen.growth_height);//线的高度

    private int pointSize = ArmsUtils.getDimens(getContext(), R.dimen.growth_height);//圆心的半径
