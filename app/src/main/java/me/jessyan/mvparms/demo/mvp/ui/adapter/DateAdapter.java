 ...
 * ================================================
 */
public class DateAdapter extends DefaultAdapter<HAppointments> {

    public DateAdapter(List<HAppointments> categories) {
        super(categories);
    }

    @Override
    public BaseHolder<HAppointments> getHolder(View v, int viewType) {
