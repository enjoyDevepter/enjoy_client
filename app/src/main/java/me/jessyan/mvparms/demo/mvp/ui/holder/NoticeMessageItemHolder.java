 ...
 * ================================================
 */
public class NoticeMessageItemHolder extends BaseHolder<NoticeMessage> {
    ...
    public NoticeMessageItemHolder(View itemView) {
        super(itemView);
    }


    @Override
    public void setData(NoticeMessage message, int position) {
