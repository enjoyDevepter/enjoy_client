...
public interface MealOrderConfirmContract {
    ...
    interface View extends IView {
        ...
        void updateUI(MealOrderConfirmResponse response);
    }

    //Model层定义接口,外部只需关心Model返回的数据,无需关心内部细节,即是否使用缓存
    interface Model extends IModel {
        Observable<MealOrderConfirmResponse> getMealOrderConfirmInfo(MealOrderConfrimRequest request);

        Observable<PayMealOrderResponse> placeMealOrder(PayMealOrderRequest request);
    }
}
