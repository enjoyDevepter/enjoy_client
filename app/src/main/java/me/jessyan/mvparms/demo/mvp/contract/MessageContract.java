...
public interface MessageContract {
    ...
    interface View extends IView {
        ...
        void showPrivateDetail(PrivateMessage privateMessage);

        void showNotice(NoticeMessage noticeMessage);

        void showDynamic(DynamicMessage dynamicMessage);
    ...
    interface Model extends IModel {
        ...
        Observable<MessageDetailResponse> getNoticeDetail(MessageDetailRequest request);

        Observable<BaseResponse> reply(MessageDetailRequest request);
    }
}
