...
public interface KGoodsOrderConfirmContract {
    ...
    interface View extends IView {
        ...
        void updateUI(HGoodsOrderConfirmInfoResponse response);
    }

    //Model层定义接口,外部只需关心Model返回的数据,无需关心内部细节,即是否使用缓存
    interface Model extends IModel {

        Observable<HGoodsOrderConfirmInfoResponse> getOrderConfirmInfo(HGoodsOrderConfirmInfoRequest request);


        Observable<HGoodsPayOrderResponse> placeHGoodsOrder(HGoodsPayOrderRequest request);
