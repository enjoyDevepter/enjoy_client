 ...
 * ================================================
 */
public class MealGoodsListItemHolder extends BaseHolder<MealGoods> {
    ...
    public MealGoodsListItemHolder(View itemView, TaoCanListAdapter.OnChildItemClickLinstener onChildItemClickLinstener) {
        super(itemView);
    ...
    public void onClick(View view) {
        if (null != onChildItemClickLinstener) {
            switch (view.getId()) {
                case R.id.buy:
                    onChildItemClickLinstener.onChildItemClick(view, TaoCanListAdapter.ViewName.BUY, getLayoutPosition());
                    return;
            }
        }
        onChildItemClickLinstener.onChildItemClick(view, TaoCanListAdapter.ViewName.ITEM, getLayoutPosition());
    }
