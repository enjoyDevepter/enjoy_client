 ...
 * ================================================
 */
public class MyDiaryListItemHolder extends BaseHolder<Diary> {
    ...
    private MyDiaryListAdapter.OnChildItemClickLinstener onChildItemClickLinstener;

    public MyDiaryListItemHolder(View itemView, MyDiaryListAdapter.OnChildItemClickLinstener onChildItemClickLinstener) {
        super(itemView);
    ...
    public void onClick(View view) {
        if (null != onChildItemClickLinstener) {
            switch (view.getId()) {
                case R.id.left:
                    onChildItemClickLinstener.onChildItemClick(view, MyDiaryListAdapter.ViewName.LEFT_IMAGE, getAdapterPosition());
                    return;
                case R.id.right:
                    onChildItemClickLinstener.onChildItemClick(view, MyDiaryListAdapter.ViewName.RIGHT_IMAGE, getAdapterPosition());
                    return;
                ...
                case R.id.browse_layout:
                    onChildItemClickLinstener.onChildItemClick(view, MyDiaryListAdapter.ViewName.SHARE, getAdapterPosition());
                    return;
            }
        }
