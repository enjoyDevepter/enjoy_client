 ...
 * ================================================
 */
public class CommonUserInfoHolder extends BaseHolder<CommonUserInfo> {
    ...
    public CommonUserInfoHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void setData(CommonUserInfo category, int position) {
        Observable.just(category.getLabel()).subscribe(new Consumer<String>() {
            @Override
