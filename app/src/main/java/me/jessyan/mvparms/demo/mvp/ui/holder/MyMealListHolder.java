...
public class MyMealListHolder extends BaseHolder<Appointment> {
    ...
    public MyMealListHolder(View itemView, MyMealListAdapter.OnChildItemClickLinstener onChildItemClickLinstener) {
        ...
        changeV.setOnClickListener(this);
    ...
    public void onClick(View view) {
        if (null != onChildItemClickLinstener) {
            switch (view.getId()) {
                case R.id.detail:
                    onChildItemClickLinstener.onChildItemClick(view, MyMealListAdapter.ViewName.MAKE_CANCEL_DETAIL, getAdapterPosition());
                    return;
                case R.id.change:
                    onChildItemClickLinstener.onChildItemClick(view, MyMealListAdapter.ViewName.CHANGE, getAdapterPosition());
                    return;
            }
        }
