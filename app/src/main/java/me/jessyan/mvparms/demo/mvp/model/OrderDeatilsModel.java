...
@ActivityScope
public class OrderDeatilsModel extends BaseModel implements OrderDeatilsContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public OrderDeatilsModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
