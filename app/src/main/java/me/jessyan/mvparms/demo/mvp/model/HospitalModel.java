...
@ActivityScope
public class HospitalModel extends BaseModel implements HospitalContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public HospitalModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<HospitalResponse> getHospitalList(HospitalListRequest request) {
