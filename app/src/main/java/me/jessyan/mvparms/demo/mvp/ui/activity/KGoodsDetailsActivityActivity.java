...
import me.jessyan.mvparms.demo.mvp.presenter.KGoodsDetailsActivityPresenter;
...
public class KGoodsDetailsActivityActivity extends BaseActivity<KGoodsDetailsActivityPresenter> implements KGoodsDetailsActivityContract.View, View.OnClickListener, DefaultAdapter.OnRecyclerViewItemClickListener, LabelsView.OnLabelSelectChangeListener, DiaryListAdapter.OnChildItemClickLinstener {
    ...
    KGoodsDetailsResponse response;
    ...
    public void setupActivityComponent(AppComponent appComponent) {
        DaggerKGoodsDetailsActivityComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .kGoodsDetailsActivityModule(new KGoodsDetailsActivityModule(this))
                .build()
                .inject(this);
    }
    ...
    public int initView(Bundle savedInstanceState) {
        return R.layout.activity_kgoods_details; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if ("timelimitdetail".equals(where)) {
            ...
            timeLimitLayoutV.setVisibility(View.GONE);
            cartV.setVisibility(View.INVISIBLE);
    ...
    @Override
    public void updateUI(KGoodsDetailsResponse response) {
