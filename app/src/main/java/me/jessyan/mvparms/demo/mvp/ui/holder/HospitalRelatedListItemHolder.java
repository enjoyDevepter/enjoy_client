 ...
 * ================================================
 */
public class HospitalRelatedListItemHolder extends BaseHolder<HospitalBean> {
    @BindView(R.id.name)
    TextView nameTV;
    @BindView(R.id.address)
    TextView addressTV;

    public HospitalRelatedListItemHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void setData(HospitalBean hospital, int position) {
