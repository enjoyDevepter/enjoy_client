...
public interface KGoodsDetailsActivityContract {
    ...
    interface View extends IView {
        ...
        void updateUI(KGoodsDetailsResponse response);
    ...
    interface Model extends IModel {
        ...
        Observable<KGoodsDetailsResponse> getGoodsDetails(GoodsDetailsRequest request);
