...
@ActivityScope
public class HGoodsOrderConfirmModel extends BaseModel implements HGoodsOrderConfirmContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public HGoodsOrderConfirmModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
