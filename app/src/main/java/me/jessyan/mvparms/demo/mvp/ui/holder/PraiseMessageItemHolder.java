 ...
 * ================================================
 */
public class PraiseMessageItemHolder extends BaseHolder<PraiseMessage> {
    ...
    public PraiseMessageItemHolder(View itemView) {
        super(itemView);
    ...
    @Override
    public void setData(PraiseMessage message, int position) {
        Observable.just(message.getName())
