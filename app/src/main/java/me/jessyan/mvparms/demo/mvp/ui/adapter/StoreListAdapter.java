...
import me.jessyan.mvparms.demo.mvp.ui.holder.StorelListItemHolder;
 ...
 * ================================================
 */
public class StoreListAdapter extends DefaultAdapter<Store> {
    ...
    public BaseHolder<Store> getHolder(View v, int viewType) {
        return new StorelListItemHolder(v);
    }
