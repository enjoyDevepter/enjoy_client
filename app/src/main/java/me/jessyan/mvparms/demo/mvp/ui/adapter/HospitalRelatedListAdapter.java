...
public class HospitalRelatedListAdapter extends DefaultAdapter<HospitalBean> {
    public HospitalRelatedListAdapter(List<HospitalBean> hospitals) {
        super(hospitals);
    }

    @Override
    public BaseHolder<HospitalBean> getHolder(View v, int viewType) {
        return new HospitalRelatedListItemHolder(v);
    }
